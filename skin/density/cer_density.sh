...
START_GRO="npt_8.tpr" # The name of the input (starting) gro file
TPR="npt_8.tpr"       # The name of the input tpr file
OUT="density.xvg"    # The name of the output file you want to create
NG=3                      # The number of groups you want to compute the density for
NDX="density.ndx"          # The name of the index file you want to create
XTC_ALL="combined.xtc"  # The name of your trajectory file
BEGINTIME=15000             # The time in ps that you want to start averaging from
ENDTIME=20000		# The time in ps that we finsih averaging
...
g_density_d -f $XTC_ALL -n $NDX -s $TPR -o $OUT -ng $NG -d z -sl 50 -b $BEGINTIME -e $ENDTIME <<+
2
3
9
+
