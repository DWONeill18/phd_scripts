...
NG=4                      # The number of groups you want to compute the density for
NDX="head_density.ndx"          # The name of the index file you want to create
...
g_density_d -f $XTC_ALL -n $NDX -s $TPR -o head_density.xvg -ng $NG -d z -sl 50 -b $BEGINTIME -e $ENDTIME <<+
13
14
15
16
